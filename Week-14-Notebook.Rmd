...
#loading up our data 
library(readr)
df1 <- read_csv("D:/R Stuff/R Stuff Moringa/Unsupervised-Learning-R-Week-14/Supermarket_Dataset_1 - Sales Data.csv")
head(df1)
str(df1)
```
...
str(df)
out = clustvarsel(df, sampsize =  50, samp = TRUE)
out
```
```{r}
summary(out$model)
...
path <-"D:/R Stuff/R Stuff Moringa/Unsupervised-Learning-R-Week-14/Supermarket_Sales_Dataset II.csv"
